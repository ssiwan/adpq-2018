/*
*    ADPQ-Staging-Tests.groovy
*    created by HOTB Software
*
*    This script runs unit tests against the existing staging website. Tests are written in python and built and run
*    using docker. The following code will be executed whenever the Jenkins Job "ADPQ-Staging-Tests" is triggered.
*
*/
...
def sendSlackNotification() {
    stage ('Notify') {
        ...
        sh "sleep 10 && node ./src/devops/scripts/slackNotification.js \"$RESULT_TYPE\" \"*Automated Test Results*\" \"$RESULTS\""
    }
}